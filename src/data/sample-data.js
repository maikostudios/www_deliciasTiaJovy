...
export const sampleProducts = [
  // Tortas
  {
    ...
    featured: true,
    ingredients: ['Chocolate belga', 'Manjar casero', 'Huevos frescos', 'Harina integral']
  },
  {
    id: 2,
    ...
    description: 'Torta esponjosa con crema chantilly y frutillas frescas de temporada',
    featured: true,
    ingredients: ['Frutillas frescas', 'Crema chantilly', 'Bizcocho de vainilla', 'Azúcar flor']
  },
  {
    id: 3,
    ...
    featured: false,
    ingredients: ['Leche condensada', 'Leche evaporada', 'Crema de leche', 'Canela']
  },
  ...
  // Panadería
  {
    ...
    featured: true,
    ingredients: ['Harina de trigo', 'Manteca de cerdo', 'Sal marina', 'Levadura natural']
  },
  {
    id: 5,
    ...
    description: 'Empanadas caseras de pino con carne, cebolla, huevo duro y aceituna',
    featured: false,
    ingredients: ['Carne molida', 'Cebolla', 'Huevo duro', 'Aceitunas', 'Masa casera']
  },
  {
    id: 6,
    ...
    description: 'Sopaipillas doradas y crujientes, perfectas para acompañar el té',
    featured: false,
  ...
  // Sin Azúcar
  {
    ...
    featured: true,
    ingredients: ['Stevia natural', 'Harina integral', 'Frutas frescas', 'Yogurt natural']
  },
  {
    id: 8,
    ...
    description: 'Galletas integrales con avena, sin azúcar añadida, endulzadas naturalmente',
    featured: false,
  ...
  // Ofertas
  {
    ...
    featured: true,
    includes: ['2 panes amasados', 'Mermelada de frutilla', 'Mantequilla', 'Té de hierbas']
  },
  {
    id: 10,
    ...
    featured: false,
    includes: ['Torta 20cm', '12 cupcakes', 'Velas numéricas', 'Decoración temática']
  }
]
...
export const sampleOrders = [
  {
    ...
    total: 21600,
    comments: 'Para retirar mañana a las 15:00. Torta con mensaje "Feliz Cumpleaños"',
...
export const businessInfo = {
  ...
  description: 'Pastelería y mini market familiar en Nueva Imperial, Chile. Productos caseros hechos con amor y los mejores ingredientes.',
